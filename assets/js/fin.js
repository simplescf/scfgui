var app = new Vue({
    ...
    data: {
        ...
        page: 1,
        currentpage: 0,
        con: { cate: "fin", searchcate: "uname", searchkey: "", paycate:"all"}
    },
    methods: {
        loadallpayorder:function(){
            this.con.paycate = "all"
            this.firstpageorder()
        },
        ...
        loadrmborder:function(){
            this.con.paycate = "rmb"
            this.firstpageorder()
        },
        loadpointorder:function(){
            this.con.paycate = "point"
            this.firstpageorder()
        },
        del:function(id){
