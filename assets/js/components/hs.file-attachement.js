	...
	$.HSCore.components.HSFileAttachment = {
		...
		_baseConfig: {
			...
			changeInput: '<div class="u-file-attach-v4 g-mb-15">\
							   <h3 class="g-font-size-16 g-color-gray-dark-v2 mb-0">点击上传文件</h3>\
			...
			templates: {
				...
				item: '<div class="js-result-list__item col-md-6 text-center g-mb-10" draggable="true">\
	              <div class="g-pa-10 g-brd-around g-brd-gray-light-v2">\
	                <p class="g-font-size-12 g-color-gray-light-v2 g-mb-5">{{fi-size2}}</p>\
	                <div class="g-mb-10 g-overflow-hidden g-height-50">{{fi-image}}</div>\
